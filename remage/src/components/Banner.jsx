      ...
      <div className="banner-container">
        <div className="banner-item left">
          <div className="banner-content">
            <div className="banner-images">
              <img src="/img/banner1-1.png" alt="Banner 1-1" className="banner-image" />
              <img src="/img/banner1-2.png" alt="Banner 1-2" className="banner-image" />
            </div>
        ...
        <div className="banner-item right">
          <div className="banner-content">
            ...
            <img src="/img/banner2.png" alt="Banner 2" className="banner-image resize" />
          </div>
        </div>
      </div>
    </div>
