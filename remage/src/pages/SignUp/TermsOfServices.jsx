...
const TermsOfServices = ({
  ...
  const termsOfServicesText = (
    <p>
      <p>
        이 약관은 Re:WEAR (이하 "회사")가 운영하는 rewear.world (이하
        "사이트")에서 제공하는 모든 서비스(이하 "서비스")의 이용과 관련하여
      ...
      <p>
        1. "회원"이란 사이트에 접속하여 이 약관에 따라 회사와 이용계약을
        체결하고, 회사가 제공하는 서비스를 이용하는 고객을 말합니다.
      </p>
      <p>
        2. "아이디(ID)"란 회원의 식별과 서비스 이용을 위하여 회원이 설정하고
        회사가 승인하는 문자와 숫자의 조합을 의미합니다.
      </p>
      <p>
        3. "비밀번호"란 회원이 부여받은 아이디와 일치된 회원임을 확인하고 회원의
        비밀보호를 위해 회원 자신이 설정한 문자와 숫자의 조합을 의미합니다.
      </p>
      <br></br>

      <strong>제 3 조 (약관의 게시와 개정)</strong>
      <p>
        1. 회사는 이 약관의 내용을 회원이 쉽게 알 수 있도록 사이트 초기 화면에
        게시합니다.
      </p>
      <p>
        2. 회사는 "약관의 규제에 관한 법률", "정보통신망 이용촉진 및 정보보호
        등에 관한 법률(이하 '정보통신망법')" 등 관련 법을 위배하지 않는 범위에서
        이 약관을 개정할 수 있습니다.
      </p>
      <p>
        3. 회사가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여
        현행약관과 함께 사이트의 초기 화면에 그 적용일자 7일 전부터 공지합니다.
      </p>
      <br></br>
      ...
      <p>
        2. 회사는 서비스의 내용 및 제공일자를 변경할 수 있으며, 이 경우 변경
        사유 및 일자를 명시하여 사전에 공지합니다.
      </p>
      <br></br>
      ...
      <p>
        2. 회사는 서비스 제공의 일시적 중단으로 발생하는 손해에 대하여 책임을
        지지 않습니다. 단, 회사에 고의 또는 중대한 과실이 있는 경우에는 그러하지
        아니합니다.
      </p>
      <br></br>
      ...
      <p>
        1. 회원가입은 회원이 약관의 내용에 대하여 동의를 하고, 가입신청을 한 후
      ...
      <p>
        1. 회원은 언제든지 사이트의 관리자에게 탈퇴를 요청할 수 있으며, 회사는
        즉시 회원 탈퇴를 처리합니다.
      </p>
      <p>
        2. 회원이 다음 각 호의 사유에 해당하는 경우, 회사는 회원 자격을 제한 및
        정지시킬 수 있습니다.
      </p>
      <ul style={{ paddingLeft: "20px" }}>
      ...
      <p>
        1. 회사가 회원에 대한 통지를 하는 경우, 회원이 회사에 제출한 이메일
        주소로 할 수 있습니다.
      </p>
      <p>
      ...
      <p>
        회사는 회원의 개인정보를 보호하고 존중합니다. 회사의 개인정보 보호정책은
        별도로 공지하며, 회원의 개인정보는 관련 법령 및 회사의 개인정보
        보호정책에 따라 보호됩니다.
      </p>
      <br></br>
      ...
      <p>
        2. 회사는 회원이 안전하게 서비스를 이용할 수 있도록 개인정보 보호를 위해
        보안 시스템을 갖추어야 합니다.
      </p>
      <br></br>
      ...
      <p>
        2. 회원은 사이트를 이용함으로써 얻은 정보 중 회사에 지적재산권이 귀속된
      ...
      <p>
        1. 회사는 회원으로부터 제출되는 불만사항 및 의견을 신속하게 처리합니다.
        다만, 신속한 처리가 곤란한 경우 회원에게 그 사유와 처리 일정을 즉시
        통보합니다.
      </p>
      <p>
        2. 회사와 회원 간에 발생한 전자상거래 분쟁과 관련하여 회원의
        피해구제신청이 있는 경우 공정거래위원회 또는 시ㆍ도지사가 의뢰하는
      ...
      <p>
        1. 회사와 회원 간에 발생한 분쟁에 관한 소송은 회사의 본사 소재지를
        관할하는 법원을 전속 관할 법원으로 합니다.
      </p>
      <p>
        2. 회사와 회원 간에 제기된 전자상거래 소송에는 대한민국 법을 적용합니다.
      </p>
    </p>
  );
  const personalInformationText = (
    <p>
      Re:WEAR는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고
      이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과
      같이 개인정보 처리방침을 수립·공개합니다.
      <br />
      <br />
      <strong>제 1조(개인정보의 처리목적)</strong> Re:WEAR는 다음의 목적을
      위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의
      ...
      유지·관리, 서비스 부정이용 방지, 만 14세 미만 아동의 개인정보 처리 시 법정
      대리인의 동의여부 확인, 각종 고지·통지, 고충처리 목적으로 개인정보를
      처리합니다.
      <br />
      2. 재화 또는 서비스 제공
      <br />
  ...
  const handleNextButton = (event, userType) => {
    ...
    navigate(`/sign-up/userinfo/`, {
      state: { from: "TermsOfServices", userType: userType },
    });
  };
  return (
