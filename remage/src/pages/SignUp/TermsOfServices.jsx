...
const TermsOfServices = ({
  ...
  const termsOfServicesText =
      ...
      <h2><strong>제 1 조 (목적)</strong></h2>
      <p>이 약관은 Re:WEAR (이하 "회사")가 운영하는 rewear.world (이하 "사이트")에서 제공하는 모든 서비스(이하 "서비스")의 이용과 관련하여 회사와 회원의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
      <br></br>

      <h2><strong>제 2 조 (정의)</strong></h2>
      ...
      <h2><strong>제 3 조 (약관의 게시와 개정)</strong></h2>
      ...
      <h2><strong>제 4 조 (서비스의 제공 및 변경)</strong></h2>
      ...
      <h2><strong>제 5 조 (서비스의 중단)</strong></h2>
      ...
      <h2><strong>제 6 조 (회원가입)</strong></h2>
      ...
      <h2><strong>제 7 조 (회원 탈퇴 및 자격 상실 등)</strong></h2>
      ...
      <h2><strong>제 8 조 (회원에 대한 통지)</strong></h2>
      ...
      <h2><strong>제 11 조 (회원의 의무)</strong></h2>
      ...
      <h2><strong>제 12 조 (저작권의 귀속 및 이용제한)</strong></h2>
      ...
      <h2><strong>제 13 조 (분쟁해결)</strong></h2>
      ...
      <h2><strong>제 14 조 (재판권 및 준거법)</strong></h2>
