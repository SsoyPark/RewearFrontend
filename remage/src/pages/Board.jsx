...
const Board = () => {
  ...
  const corporateFaqs = [
    { question: "기업 사용 FAQ 1", answer: "주문에 대한 답변입니다." },
    { question: "기업 사용 FAQ 2", answer: "배송에 대한 답변입니다." },
    { question: "기업 사용 FAQ 3", answer: "기타에 대한 답변입니다." },
    { question: "기업 사용 FAQ 4", answer: "기업 사용 FAQ 4에 대한 답변입니다." },
    { question: "기업 사용 FAQ 5", answer: "주문에 대한 답변입니다." },
    { question: "기업 사용 FAQ 6", answer: "기업 사용 FAQ 6에 대한 답변입니다." },
    { question: "기업 사용 FAQ 7", answer: "배송에 대한 답변입니다." },
    { question: "기업 사용 FAQ 8", answer: "기업 사용 FAQ 8에 대한 답변입니다." },
  ];
