...
const Board = () => {
  ...
  const generalFaqs = [
    { question: "요청사항 입력은 왜 입력하나요?", 
      answer: "해당 요청사항을 기반으로 리폼한 이미지가 생성됩니다. 입력하지 않을 경우, 리폼이미지가 제대로 생성되지 않을 수 있으니 주의하시기 바랍니다." },
    { question: "업로드에 사용 가능한 이미지 형식에는 어떤 것이 있나요?", 
      answer: "jpg, png, jpeg 형식의 이미지를 업로드 하실 수 있습니다." },
    ...
    { question: "리폼은 상의만 되는건가요?", 
      answer: "현재 스웨터, 셔츠, 티셔츠만 리폼을 진행하여 가상피팅 서비스를 제공하고 있습니다. 추후 빠른 시일 내에 다른 의류까지도 서비스를 확장하겠습니다." },
